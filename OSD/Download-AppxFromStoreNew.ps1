...
-StoreURL https://apps.microsoft.com/detail/adobe-photoshop-express/9WZDNCRFJ27N
#>
...
$ToDownload=$newHtml.getElementsByTagName("a") | Select-Object textContent, href,innerText
...
{
    Write-host "Downloading $($Download.href)..."
    Write-host "($($Download.innerText))"
	$wchttp.DownloadFile($Download.href, "$SavePathRoot\$ProductID\$($Download.innerText)")
    Write-host ""
